...
<body>
    ...
    <div class="container"><hr>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="row">
                    <h4 class="text-center">Çalışanlar</h4>
				<hr>
				<table class="table" >
					<tr>
						<th>STAFF ID</th>
                    ...
                    <?php 
                    $verial=$conn->prepare("SELECT * from STAFF");
                    ...
                    while($veriler=$verial->fetch(PDO::FETCH_ASSOC)){ ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $veriler['staffName'] ?></td>
                            <td><?php echo $veriler['staffSurname'] ?></td>
                           <td> <a href="islem.php?cs=<?php echo $veriler['staffId']?>&calisansil=ok"><button class="btn btn-danger">Sil</button></a>
            ...
            <div class="col-md-4" >
						<h4 class="text-center">Çalışan Ekle	</h4><hr>

				 <form action="islem.php" method="POST">
                    <input type="hidden" value="NULL" name="customerId">
                    <input type="hidden" value='Insert' name="StatementType">
					
						<label for="staffName">STAFF FIRST NAME:  </label>
						<input type="text" name="staffName"  value="" ><br><br>
						<label for="staffSurname">STAFF LAST NAME: </label>
						<input type="text" name="staffSurname" value="" ><br><br>
						
						
						
						<button class="btn btn-success "    type="submit" name="sp_calisan">Tamamla </button><br>
